...
const View = ({char}) => {
    ...
    return (
        ...
        <ul className="char__comics-list">
            ...
            {comics.length === 0? <li className="char__comics-item">
                    NO COMICSES
                </li> :<Comisclist comics={comics}/>}
        </ul>
      </>
    )
}
...
//максимум 10 комиксов
//если нет комиксов - вывести сообщение
// как обычно ебля с картинкой